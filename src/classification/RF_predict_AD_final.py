...
# remove all suspicious samples identified from PCA
# sus_samples = [257, 130, 132, 5, 262, 135, 263, 265, 266, 140, 271, 16, 18, 150, 23, 29, 286, 287, 288, 36, 37,
#                 166, 41, 42, 172, 191, 197, 201, 75, 203, 204, 205, 212, 214, 217, 219, 120, 93, 225, 99, 227,
#                 101, 235, 241, 115, 243, 244, 245, 119, 248, 126]
# X = X.drop(sus_samples, axis=0)
# y = y.drop(sus_samples, axis=0)
...
for diseases in ['AD', 'MildCognitiveImpairment', 'NoCognitiveImpairment']:
    ...
    for i, (train, test) in enumerate(kf.split(X, y_copy)):
        ...
        print(len(forest_importances.index[forest_importances > 0].tolist()))
